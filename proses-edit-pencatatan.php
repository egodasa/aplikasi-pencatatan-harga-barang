...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
  $query = $db->prepare("UPDATE tbl_pencatatan SET tgl_pencatatan = ?, id_pangan = ? , id_kecamatan = ?, harga_jual = ?, harga_beli = ? WHERE id_pencatatan = ?");
  ...
  $query->bindParam(6, $_POST['id_pencatatan'], PDO::PARAM_INT);
  $query->execute();
}
